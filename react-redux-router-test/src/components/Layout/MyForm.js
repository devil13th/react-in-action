  ...
  render() {
    ...
    return (
      ...
      <Form  layout="inline" onSubmit={this.handleSubmit} className="login-form" id="components-form-demo-normal-login">
        <FormItem {...formItemLayout} label="表单ID" className="w">
        ...
        <FormItem {...formItemLayout}  label="菜单功能ID" className="w">
        ...
        <FormItem {...formItemLayout} label="表单名称" className="w">
        ...
        <FormItem {...formItemLayout}  label="菜单标题" className="w">
        ...
        <FormItem {...formItemLayout} label="表单标题" className="w">
        ...
        <FormItem {...formItemLayout}  label="上级菜单功能ID" className="w">
        ...
        <FormItem {...formItemLayout}  label="描述" className="w">
        ...
        <FormItem {...formItemLayout} label="菜单描述" className="w">
