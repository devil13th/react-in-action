  ...
  plugins: [
    ...
    */
    ...
    new CopyWebpackPlugin([
      {
        from: __dirname + '/src/vendor/antd-with-locales.js',
        to: __dirname + '/dist'
      },
      {
        from: __dirname + '/src/vendor/dva.min.js',
        to: __dirname + '/dist'
      },
      {
        from: __dirname + '/src/vendor/moment.min.js',
        to: __dirname + '/dist'
      },
      {
        from: __dirname + '/src/vendor/react.production.min.js',
        to: __dirname + '/dist'
      },
      {
        from: __dirname + '/src/vendor/react-dom.production.min.js',
        to: __dirname + '/dist'
      },
      {
        from: __dirname + '/src/vendor/babel.min.js',
        to: __dirname + '/dist'
      },
      
      {
        from: __dirname + '/src/vendor/polyfill.min.js',
        to: __dirname + '/dist'
      },
      
      
      {
        from: __dirname + '/src/vendor/antd.css',
        to: __dirname + '/dist'
      }
    ]),
